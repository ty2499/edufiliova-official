...
async function main() {
  await pushFile('server/dodopay-routes.ts', '/home/runner/workspace/server/dodopay-routes.ts', 
    'Fix Dodo Payments redirect URL - use request origin instead of localhost fallback');
}
