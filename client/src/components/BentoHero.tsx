...
const heroImages: Record<string, string> = {
  Students: studentsHeroImage,
  Teachers: teachersHeroImage,
  Freelancers: freelancersHeroImage,
  Creators: creatorsHeroImage
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className="flex items-center gap-1 px-3 py-1.5 bg-white rounded-full border border-gray-200 shadow-sm">
            <span className="text-sm font-medium text-gray-700">For Students, Teachers, Freelancers and Creators</span>
          </div>
        </div>
