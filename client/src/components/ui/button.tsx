...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-bold transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer border-0",
  {
    variants: {
      variant: {
        ...
        outline: "bg-transparent text-foreground hover:bg-[#a0fab2] hover:text-[#2f5a4e] hover:scale-105 active:scale-95 focus-visible:ring-primary transition-all",
        secondary: "bg-secondary text-white hover:bg-secondary/80 hover:scale-105 active:scale-95 focus-visible:ring-secondary",
        ghost: "hover:bg-[#a0fab2] hover:text-[#2f5a4e] text-foreground active:scale-95 hover:scale-105",
