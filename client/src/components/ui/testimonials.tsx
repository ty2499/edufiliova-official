        ...
        <section className="py-16 md:py-32 relative bg-black overflow-hidden">
            ...
            <div className="mx-auto max-w-6xl space-y-8 px-6 md:space-y-16 relative z-10">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-[40px] font-bold text-white">Built by <span style={{ color: '#a0fab2' }}>Educators</span>, loved by thousands of <span style={{ color: '#a0fab2' }}>Learners</span></h2>
                ...
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
                    <div className="sm:col-span-2 lg:row-span-2 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all duration-300" data-testid="card-testimonial-0">
                    ...
                    <div className="md:col-span-2 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all duration-300" data-testid="card-testimonial-1">
                        <blockquote className="flex flex-col h-full gap-3">
                    ...
                    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all duration-300" data-testid="card-testimonial-2">
                        <blockquote className="flex flex-col h-full gap-3">
                    ...
                    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all duration-300" data-testid="card-testimonial-3">
                        <blockquote className="flex flex-col h-full gap-3">
