        ...
        <div className="relative flex-shrink-0 md:w-1/2 md:fixed md:left-0 md:top-0 md:h-screen md:overflow-hidden">
          ...
          {showNotNow && (
            <button
              ...
              className="absolute top-4 right-4 z-[100] px-4 py-2 text-sm font-medium text-white bg-black/30 hover:bg-black/50 backdrop-blur-sm rounded-full transition-all md:hidden"
          ...
          {showBackButton && onBack && (
            <button
              onClick={onBack}
              className="absolute top-4 left-4 z-[100] p-2 text-white bg-black/30 hover:bg-black/50 backdrop-blur-sm rounded-full transition-all md:hidden"
