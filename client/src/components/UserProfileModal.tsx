    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-md sm:max-w-lg p-0 overflow-hidden max-h-[90vh] overflow-y-auto" showClose={false}>
        ...
        <div className="bg-gradient-to-br from-[#A0FAB2] via-green-400 to-emerald-500 h-24 sm:h-28 relative">
          <button
            onClick={onClose}
            className="absolute top-3 left-3 sm:top-4 sm:left-4 p-1.5 hover:bg-white/20 rounded-full transition-colors z-10 transition-all duration-300"
          ...
          <div className="flex gap-3">
            {onStartChat && (
              <Button 
                ...
                className="flex-1 bg-gradient-to-r from-[#A0FAB2] to-green-500 hover:from-green-500 hover:to-green-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 transition-all duration-300"
