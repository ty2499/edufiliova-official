      ...
      if (fileType?.startsWith('audio/')) {
        return (
          <div className="flex items-center space-x-3 min-w-[200px]">
            <button
              onClick={toggleAudio}
              className="flex-shrink-0 w-10 h-10 bg-blue-500 hover:bg-primary rounded-full flex items-center justify-center transition-all duration-300"
            >
              {isPlaying ? (
      ...
      return (
        <div className="flex items-center space-x-3 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg max-w-xs">
          ...
          <button
            ...
            className="flex-shrink-0 p-1 hover:bg-gray-200 dark:hover:bg-gray-600 rounded transition-all duration-300"
          >
