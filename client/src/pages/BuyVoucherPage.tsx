        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            {whatsappCheckout.loading ? (
              ...
              <div className="text-center py-8">
                <div className="w-20 h-20 bg-primary/15 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 mb-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="font-mono font-bold text-primary">{whatsappCheckout.code}</span>
                  </div>
                  <div className="flex justify-between items-center mb-4">
